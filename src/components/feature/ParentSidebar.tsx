...
const menuItems: MenuItem[] = [
  { path: '/parent-portal', label: 'Dashboard', icon: 'ri-dashboard-line' },
  { path: '/parent-grades', label: 'Grades & Reports', icon: 'ri-file-chart-line' },
  { path: '/parent-messages', label: 'Messages', icon: 'ri-message-3-line' },
  { path: '/parent-homework', label: 'Homework', icon: 'ri-book-open-line' },
  { path: '/parent-meetings', label: 'Meetings', icon: 'ri-calendar-event-line' },
  { path: '/parent-notifications', label: 'Notifications', icon: 'ri-notification-3-line' },
];

const portalItems: MenuItem[] = [
  { path: '/dashboard', label: 'Teacher Dashboard', icon: 'ri-school-line' },
];

export default function ParentSidebar(): JSX.Element {
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <div className="w-9 h-9 bg-blue-600 rounded-lg flex items-center justify-center">
                <i className="ri-parent-line text-lg text-white"></i>
              </div>
              <div>
                <h1 className="text-xl font-bold text-blue-600">AttendFlow Schools</h1>
                <p className="text-xs text-gray-500 mt-0.5">Parent Portal</p>
              </div>
            </div>
        ...
        <div className="px-3 py-4 border-t border-gray-200">
          <div className="flex items-center px-3 py-2">
            ...
            <div className="flex-1 min-w-0">
              <p className="text-sm font-medium text-gray-900 truncate">Robert Wilson</p>
